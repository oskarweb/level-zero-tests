 ...
 */
 ...
 ze_image_handle_t
 ImageLayoutFixture::create_image_desc_layout(
 ...
 class ImageLayoutOneAndNoKernel : public ImageLayoutFixture,
       public ::testing::WithParamInterface<
           std::tuple<ze_image_type_t, ze_image_format_type_t,
                      ze_image_format_layout_t, bool>> {};
 
 
 TEST_P(ImageLayoutOneAndNoKernel, GivenImageLayoutWhenConvertingImageToMemory) {
 ...
 INSTANTIATE_TEST_SUITE_P(
     UIntFormat, ImageLayoutOneAndNoKernel,
 ...
 INSTANTIATE_TEST_SUITE_P(
     SIntFormat, ImageLayoutOneAndNoKernel,
     ::testing::Combine(::testing::ValuesIn(tested_image_types),
 ...
 INSTANTIATE_TEST_SUITE_P(
     UNormFormat, ImageLayoutOneAndNoKernel,
     ::testing::Combine(::testing::ValuesIn(tested_image_types),
 ...
 INSTANTIATE_TEST_SUITE_P(
     SNormFormat, ImageLayoutOneAndNoKernel,
     ::testing::Combine(::testing::ValuesIn(tested_image_types),
 ...
 INSTANTIATE_TEST_SUITE_P(
     FloatFormat, ImageLayoutTwoKernels,
     ::testing::Combine(::testing::ValuesIn(tested_image_types),
